...
Check the [releases](https://github.com/droboports/mono/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/mono.git
cd mono
./build.sh
ls -la *.tgz
```
